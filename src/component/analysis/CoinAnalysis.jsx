    ...
    <>
      ...
      {aibot ? (
        <div className={`${s.analysisdiv} container`}>
          <h2>Comprehensive Market Analysis by Brand New AIbot </h2>
          ...
          {responseData && (
            <div className={`${s.marketanalysis} `}>
              ...
              <div className={s.section}>
                ...
                <p>
                  Our analysis suggests a approach based on current governance
              ...
              <div className={s.section}>
                ...
                <p>
                  ...
                  <br />
                  <em>
                    Key drivers: DeFi adoption spikes and governance rewards.
                  </em>
                </p>
                <p>
